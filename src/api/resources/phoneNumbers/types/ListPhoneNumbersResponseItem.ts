...
export interface ListPhoneNumbersResponseItem {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own).
     * - `twilio`: Twilio.
     */
    provider?: ListPhoneNumbersResponseItem.Provider;
    ...
    associated_pipeline?: ListPhoneNumbersResponseItem.AssociatedPipeline | null;
