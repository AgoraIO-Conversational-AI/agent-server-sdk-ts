...
export interface RetrieveCallRecordsResponse {
    /** Call data object. */
    data?: RetrieveCallRecordsResponse.Data;
    /** Metadata about the list. */
    meta?: RetrieveCallRecordsResponse.Meta;
    /** Request status. */
    status?: string;
}

export namespace RetrieveCallRecordsResponse {
    /**
     * Call data object.
     */
