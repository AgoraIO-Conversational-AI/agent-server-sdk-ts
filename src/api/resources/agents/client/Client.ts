...
export class AgentsClient {
    ...
    private async __start(
        ...
        return handleNonStatusCodeError(_response.error, _response.rawResponse, "POST", "/v2/projects/{appid}/join");
    }
