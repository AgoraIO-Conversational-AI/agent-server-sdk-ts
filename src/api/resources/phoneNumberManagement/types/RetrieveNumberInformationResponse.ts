...
export interface RetrieveNumberInformationResponse {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own)
     * - `twilio`: Twilio
     */
    provider?: RetrieveNumberInformationResponse.Provider;
    ...
    associated_pipeline?: RetrieveNumberInformationResponse.AssociatedPipeline;
...
export namespace RetrieveNumberInformationResponse {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own)
     * - `twilio`: Twilio
