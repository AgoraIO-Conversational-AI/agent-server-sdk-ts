...
export interface PhoneNumberManagementUpdateResponse {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own)
     * - `twilio`: Twilio
     */
    provider?: PhoneNumberManagementUpdateResponse.Provider;
    ...
    associated_pipeline?: PhoneNumberManagementUpdateResponse.AssociatedPipeline;
...
export namespace PhoneNumberManagementUpdateResponse {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own)
     * - `twilio`: Twilio
