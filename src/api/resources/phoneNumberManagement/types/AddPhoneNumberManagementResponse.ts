...
export interface AddPhoneNumberManagementResponse {
    ...
    associated_pipeline?: AddPhoneNumberManagementResponse.AssociatedPipeline | null;
}

export namespace AddPhoneNumberManagementResponse {
    /**
     * The associated pipeline information. Returns `null` if no pipeline is associated.
     */
