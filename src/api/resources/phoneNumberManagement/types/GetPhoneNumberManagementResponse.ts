...
export interface GetPhoneNumberManagementResponse {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own)
     * - `twilio`: Twilio
     */
    provider?: GetPhoneNumberManagementResponse.Provider;
    ...
    associated_pipeline?: GetPhoneNumberManagementResponse.AssociatedPipeline | null;
...
export namespace GetPhoneNumberManagementResponse {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own)
     * - `twilio`: Twilio
