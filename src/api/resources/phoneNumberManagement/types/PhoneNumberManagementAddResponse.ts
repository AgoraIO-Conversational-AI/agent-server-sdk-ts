...
export interface PhoneNumberManagementAddResponse {
    ...
    associated_pipeline?: PhoneNumberManagementAddResponse.AssociatedPipeline;
}

export namespace PhoneNumberManagementAddResponse {
    /**
     * The associated pipeline information. Returns `null` if no pipeline is associated.
     */
