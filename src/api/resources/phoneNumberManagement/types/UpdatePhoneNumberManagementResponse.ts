...
export interface UpdatePhoneNumberManagementResponse {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own)
     * - `twilio`: Twilio
     */
    provider?: UpdatePhoneNumberManagementResponse.Provider;
    ...
    associated_pipeline?: UpdatePhoneNumberManagementResponse.AssociatedPipeline | null;
...
export namespace UpdatePhoneNumberManagementResponse {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own)
     * - `twilio`: Twilio
