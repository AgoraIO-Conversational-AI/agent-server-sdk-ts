...
export interface PhoneNumberManagementGetResponse {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own)
     * - `twilio`: Twilio
     */
    provider?: PhoneNumberManagementGetResponse.Provider;
    ...
    associated_pipeline?: PhoneNumberManagementGetResponse.AssociatedPipeline;
...
export namespace PhoneNumberManagementGetResponse {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own)
     * - `twilio`: Twilio
