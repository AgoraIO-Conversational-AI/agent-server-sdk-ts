...
export interface PhoneNumberManagementListResponseItem {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own).
     * - `twilio`: Twilio.
     */
    provider?: PhoneNumberManagementListResponseItem.Provider;
    ...
    associated_pipeline?: PhoneNumberManagementListResponseItem.AssociatedPipeline;
...
export namespace PhoneNumberManagementListResponseItem {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own).
     * - `twilio`: Twilio.
