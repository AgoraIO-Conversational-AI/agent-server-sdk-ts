...
export interface ListPhoneNumberManagementResponseItem {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own).
     * - `twilio`: Twilio.
     */
    provider?: ListPhoneNumberManagementResponseItem.Provider;
    ...
    associated_pipeline?: ListPhoneNumberManagementResponseItem.AssociatedPipeline | null;
    /** SIP inbound call configuration details. Returns `null` if not configured. */
    inbound_config?: Record<string, unknown> | null;
    /** SIP outbound call configuration details. Returns `null` if not configured. */
    outbound_config?: Record<string, unknown> | null;
}

export namespace ListPhoneNumberManagementResponseItem {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own).
     * - `twilio`: Twilio.
