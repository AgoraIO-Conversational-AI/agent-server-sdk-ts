...
export interface UpdateNumberConfigurationResponse {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own)
     * - `twilio`: Twilio
     */
    provider?: UpdateNumberConfigurationResponse.Provider;
    ...
    associated_pipeline?: UpdateNumberConfigurationResponse.AssociatedPipeline;
...
export namespace UpdateNumberConfigurationResponse {
    /**
     * Number provider:
     * - `byo`: BYO (Bring Your Own)
     * - `twilio`: Twilio
