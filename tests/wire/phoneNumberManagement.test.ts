...
describe("PhoneNumberManagementClient", () => {
    test("list", async () => {
    ...
    test("get", async () => {
        ...
        const response = await client.phoneNumberManagement.get({
    ...
    test("delete", async () => {
        ...
        const response = await client.phoneNumberManagement.delete({
            phone_number: "phone_number",
        });
    ...
    test("update", async () => {
        ...
        const response = await client.phoneNumberManagement.update({
            phone_number: "phone_number",
            inbound_config: {
                pipeline_id: "xxxxx",
            },
